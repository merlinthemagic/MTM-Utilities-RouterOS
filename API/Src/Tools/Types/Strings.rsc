:local cPath "MTM/Utilities/Tools/Types/Strings.rsc";
:local s [:toarray ""];

:set ($s->"getRandom") do={

	:local cPath "MTM/Utilities/Tools/Types/Strings.rsc/getRandom";
	:if ([:typeof $0] != "num") do={
...
:set ($s->"trim") do={
	...
	:local cPath "MTM/Utilities/Tools/Types/Strings.rsc/trim";
	:if ([:typeof $0] != "str") do={
		:if ([:typeof $0] = "nil") do={
			:return "";
		} else={
...
:set ($s->"replace") do={
	...
	:local cPath "MTM/Utilities/Tools/Types/Strings.rsc/replace";
	:if ([:typeof $0] != "str") do={
...
:set ($s->"toLower") do={
	...
	:local cPath "MTM/Utilities/Tools/Types/Strings.rsc/toLower";
	:if ([:typeof $0] != "str") do={
		:error ($cPath.": Input string has invalid type '".[:typeof $0]."'");
	}
...
:set ($s->"toUpper") do={
	...
	:local cPath "MTM/Utilities/Tools/Types/Strings.rsc/toUpper";
	:if ([:typeof $0] != "str") do={
		:error ($cPath.": Input string has invalid type '".[:typeof $0]."'");
	}
...
:set ($s->"split") do={
	...
	:local cPath "MTM/Utilities/Tools/Types/Strings.rsc/split";
	:if ([:typeof $0] != "str") do={
		:if ([:typeof $0] = "nil") do={
			:return [:toarray ""];
		} else={
...
:set ($s->"chunk") do={
	...
	:local cPath "MTM/Utilities/Tools/Types/Strings.rsc/chunk";
	:if ([:typeof $0] != "str") do={
		:error ($cPath.": Input string has invalid type '".[:typeof $0]."'");
	}
	:if ([:typeof $1] != "num") do={
